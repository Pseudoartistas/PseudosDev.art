...
import { ActiveLink } from '../header/assets/nav_components';
...
export default function Nav() {
	...
	return (
        <Popover.Root>
            ...
            <Popover.Portal>
                <Popover.Content className='w-screen h-screen colorsBase'>

                    <NavigationMenu.Root orientation="vertical">
                            <NavigationMenu.List className="items-center gap-3 text-sm z-80">
                                <NavigationMenu.Item>
                                ...
                                <NavigationMenu.Item>
                                    <NavigationMenu.Trigger className="groupitems-center gap-1 rounded-sm px-3 py-1 hoverButton aria-expanded:font-black aria-expanded:bg-neutral-900/5 dark:aria-expanded:bg-neutral-50/5">
                                    ...
                                    <NavigationMenu.Content className="animacaoMenu" onPointerEnter={(event) => event.preventDefault()} onPointerLeave={(event) => event.preventDefault()}>
                                        <div className="colorsBase w-full">
                                            <ul className="animate-enterFromTop grid grid-flow-col grid-rows-3 gap-5 overflow-x-scroll p-5 max-md:grid-flow-row max-md:w-full max-md:overflow-y-scroll">
                                                <li className="row-span-3">
                                                    <NavigationMenu.Link asChild className="w-full h-full max-md:min-w-full min-w-80 max-md:min-h-64">
                                                        <a href="/" className="flex flex-col justify-end rounded-lg bg-gradient-to-b from-muted/50 to-muted p-5 max-md:pointer-events-none">
                                                            <Logos.LogoANotaVH />
